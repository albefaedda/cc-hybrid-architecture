...
/* Insert Customers */
insert into grocery_shop.customers (customer_id, customer_name, customer_email, customer_address, last_update_time) values('53-570-6948', 'Linet Pedroni', 'lpedroni0@whitehouse.gov', '56 Di Loreto Terrace', '2022-07-02 22:55:23'::timestamp);
insert into grocery_shop.customers (customer_id, customer_name, customer_email, customer_address, last_update_time) values('23-606-4767', 'Peria Olivey', 'polivey1@google.com.br', '593 Thompson Drive', '2022-07-03 01:44:32'::timestamp);
insert into grocery_shop.customers (customer_id, customer_name, customer_email, customer_address, last_update_time) values('14-786-6861', 'Greg Vane', 'gvane2@skyrock.com', '1 Gale Court', '2022-07-02 10:14:42'::timestamp);
insert into grocery_shop.customers (customer_id, customer_name, customer_email, customer_address, last_update_time) values('58-308-6113', 'Jeremy Jiri', 'jjiri3@discovery.com', '2 Declaration Pass', '2022-06-11 10:14:42'::timestamp);
insert into grocery_shop.customers (customer_id, customer_name, customer_email, customer_address, last_update_time) values('19-791-0773', 'Julee Bradnum', 'jbradnum4@so-net.ne.jp', '32 Bluestem Avenue', '2022-06-10 13:12:42'::timestamp);

/* Insert Sellers */
insert into grocery_shop.sellers (seller_id, seller_name, seller_company, seller_email, seller_address, last_update_time) values('87-017-4611', 'Rad Rainbird', 'Nlounge', 'rrainbird0@blogtalkradio.com', '13 Sundown Way', '2022-07-01 10:14:42'::timestamp);
insert into grocery_shop.sellers (seller_id, seller_name, seller_company, seller_email, seller_address, last_update_time) values('51-894-3698', 'Clarence Hulstrom', 'Mybuzz', 'chulstrom1@comsenz.com', '26 Iowa Lane', '2022-07-03 12:23:12'::timestamp);
insert into grocery_shop.sellers (seller_id, seller_name, seller_company, seller_email, seller_address, last_update_time) values('79-156-2194', 'Neddie Labell', 'Wordware', 'nlabell2@shop-pro.jp', '82 Mifflin Alley', '2022-06-01 10:34:42'::timestamp);
insert into grocery_shop.sellers (seller_id, seller_name, seller_company, seller_email, seller_address, last_update_time) values('50-617-6068', 'Tess Loiterton', 'Skivee', 'tloiterton3@ted.com', '71 Washington Hill', '2022-06-21 16:45:34'::timestamp);
insert into grocery_shop.sellers (seller_id, seller_name, seller_company, seller_email, seller_address, last_update_time) values('35-950-3000', 'Randie Gresser', 'Skipstorm', 'rgresser4@globo.com', '1 Montana Court', '2022-07-07 12:38:32'::timestamp);


/* Insert Products */
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_id, last_update_time) values(1, 'Pork - Caul Fat', '$5.63', 19, '87-017-4611', '2022-07-11 18:58:42'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_id, last_update_time) values(2, 'Tarragon - Primerba, Paste', '$27.94', 27, '51-894-3698', '2022-07-09 20:05:52'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_id, last_update_time) values(3, 'Bagel - Ched Chs Presliced', '$18.01', 23, '79-156-2194', '2022-07-10 04:32:17'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_id, last_update_time) values(4, 'V8 Splash Strawberry Kiwi', '$33.85', 46, '50-617-6068', '2022-07-08 12:52:26'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_id, last_update_time) values(5, 'Potatoes - Yukon Gold, 80 Ct', '$33.92', 32, '35-950-3000', '2022-07-11 07:09:15'::timestamp);
